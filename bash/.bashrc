...
alias vl='NVIM_APNAME=lazynvim nvim'
...
# vdi 
alias wvdi='mstsc.exe /w:2500 /h:1350 &'
alias tvdi='mstsc.exe /w:3390 /h:1350 &'
...
# export kubeconfig
export KUBECONFIG=$(find /home/erik/.kube/ -name "*.yaml" -type f | tr '\n' ':' | sed 's/:$//')
